...
describe("Form", () => {
    ...
    describe("Custom field template", () => {
        ...
        it("should use the provided template for labels", () => {
            ...
            expect(
                node.querySelector(".my-template .field-string > label")
                    .textContent
            ).eql("foo*");
        });
        ...
        it("should pass description as the provided React element", () => {
            expect(
                node.querySelector("#root_foo__description").textContent
        ...
        it("should pass errors as the provided React component", () => {
            expect(node.querySelectorAll(".error-detail li")).to.have.length.of(
                1
            );
        });
        ...
        it("should pass help as a the provided React element", () => {
            expect(node.querySelector(".help-block").textContent).eql(
                "this is help"
            );
        });
    ...
    describe("Schema definitions", () => {
        it("should use a single schema definition reference", () => {
            ...
            expect(node.querySelectorAll("input[type=text]")).to.have.length.of(
                1
            );
        });
    ...
    describe("Error contextualization", () => {
        describe("on form state updated", () => {
            ...
            describe("Lazy validation", () => {
                ...
                it("should not denote an error in the field", () => {
                    ...
                    expect(
                        node.querySelectorAll(".field-error")
                    ).to.have.length.of(0);
                });
                ...
                it("should clean contextualized errors up when they're fixed", () => {
                    ...
                    // Fix the first field
                    Simulate.change(
                        node.querySelectorAll("input[type=text]")[0],
                        {
                    ...
                    Simulate.change(
                        node.querySelectorAll("input[type=text]")[1],
                        {
        ...
        describe("root level", () => {
            ...
            it("should denote the error in the field", () => {
                ...
                expect(node.querySelectorAll(".field-error")).to.have.length.of(
                    1
                );
                expect(
                    node.querySelector(".field-string .error-detail")
        ...
        describe("root level with multiple errors", () => {
            ...
            it("should denote the error in the field", () => {
                ...
                const liNodes = node.querySelectorAll(
        ...
        describe("array indices", () => {
            ...
            it("should denote the error in the item field in error", () => {
                ...
                expect(fieldNodes[1].classList.contains("field-error")).eql(
                    true
                );
            ...
            it("should not denote errors on non impacted fields", () => {
                ...
                expect(fieldNodes[0].classList.contains("field-error")).eql(
                    false
                );
                expect(fieldNodes[2].classList.contains("field-error")).eql(
                    false
                );
            });
        });
    ...
    describe("Attributes", () => {
        ...
        it("should set attr autoComplete of form", () => {
            expect(node.getAttribute("autocomplete")).eql(
        ...
        it("should set attr acceptcharset of form", () => {
            expect(node.getAttribute("accept-charset")).eql(

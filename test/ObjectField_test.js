...
describe("ObjectField", () => {
    ...
    describe("schema", () => {
        ...
        it("should render a default property label", () => {
            ...
            expect(node.querySelector(".field-boolean label").textContent).eql(
                "bar"
            );
        });
        ...
        it("should handle a default object value", () => {
            ...
            expect(node.querySelector(".field input[type=text]").value).eql(
                "hey"
            );
            expect(
        ...
        it("should handle required values", () => {
            ...
            expect(node.querySelector(".field-string label").textContent).eql(
                "Foo*"
            );
        });
        ...
        it("should render the widget with the expected id", () => {
            ...
            expect(node.querySelector("input[type=checkbox]").id).eql(
                "root_bar"
            );
        });
    });

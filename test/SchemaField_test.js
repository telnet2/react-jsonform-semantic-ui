...
describe("SchemaField", () => {
    ...
    describe("Unsupported field", () => {
        it("should warn on invalid field type", () => {
            ...
            expect(
                node.querySelector(".unsupported-field").textContent
            ).to.contain("Unknown field type invalid");
        });
    });
    ...
    describe("description support", () => {
        ...
        it("should render description if available from the schema", () => {
            ...
            expect(
                node.querySelectorAll("#root_foo__description")
            ).to.have.length.of(1);
        });
        ...
        it("should not render description if not available from schema", () => {
            ...
            expect(
                node.querySelectorAll("#root_bar__description")
            ).to.have.length.of(0);
        });
        ...
        it("should render a customized description field", () => {
            ...
            expect(node.querySelector("#custom").textContent).to.eql(
                "A Foo field"
            );
        });
    });
    ...
    describe("errors", () => {
        ...
        describe("Custom error rendering", () => {
            const customStringWidget = props => {
                return (
                    <div className="custom-text-widget">{props.rawErrors}</div>
                );
            };

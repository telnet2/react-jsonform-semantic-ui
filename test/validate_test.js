    ...
    describe("validate.validateFormData()", () => {
        ...
        describe("Custom validate function", () => {
            ...
            it("should return an errorSchema", () => {
                ...
                expect(errorSchema.pass2.__errors[0]).eql(
        ...
        describe("Invalid schema", () => {
            ...
            it("should return an errorSchema", () => {
                expect(
                    errorSchema.properties.foo.required.__errors
                ).to.have.length.of(1);
    ...
    describe("Form integration", () => {
        ...
        describe("JSONSchema validation", () => {
            describe("Required fields", () => {
                ...
                it("should render errors", () => {
                    expect(
                        node.querySelectorAll(".errors li")
                    ).to.have.length.of(1);
                ...
                it("should trigger the onError handler", () => {
                    sinon.assert.calledWith(
                        ...
                        sinon.match(errors => {
                            return (
                                errors[0].message === "is a required property"
                            );
                        })
                    );
                });
        ...
        describe("Custom ErrorList", () => {
            ...
            it("should use CustomErrorList", () => {
                ...
                expect(
                    node.querySelectorAll(".CustomErrorList")
                ).to.have.length.of(1);
                expect(node.querySelector(".CustomErrorList").textContent).eql(
                    "1 custom"
                );
                expect(node.querySelectorAll(".ErrorSchema")).to.have.length.of(
                    1
                );

...
describe("StringField", () => {
    ...
    describe("TextareaWidget", () => {
        ...
        it("should render a textarea field with rows", () => {
            ...
            expect(node.querySelector("textarea").getAttribute("rows")).eql(
                "20"
            );
        });
    });
    ...
    describe("DateWidget", () => {
        ...
        it("should render a date field", () => {
            ...
            expect(
                node.querySelectorAll(".field [type=date]")
            ).to.have.length.of(1);
        });
    ...
    describe("AltDateTimeWidget", () => {
        ...
        it("should render the widgets with the expected options' values", () => {
            ...
            const monthOptions = node.querySelectorAll(
                "select#root_month option"
            );
    ...
    describe("EmailWidget", () => {
        it("should render an email field", () => {
            ...
            expect(
                node.querySelectorAll(".field [type=email]")
            ).to.have.length.of(1);
        });
    ...
    describe("URLWidget", () => {
        it("should render an url field", () => {
            ...
            expect(
                node.querySelectorAll(".field [type=url]")
            ).to.have.length.of(1);
        });
    ...
    describe("ColorWidget", () => {
        ...
        it("should render a color field", () => {
            ...
            expect(
                node.querySelectorAll(".field [type=color]")
            ).to.have.length.of(1);
        });
    ...
    describe("FileWidget", () => {
        ...
        it("should render a color field", () => {
            ...
            expect(
                node.querySelectorAll(".field [type=file]")
            ).to.have.length.of(1);
        });

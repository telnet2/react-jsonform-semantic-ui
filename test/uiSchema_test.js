    ...
    describe("custom widget", () => {
            ...
            it("should log warning when deprecated ui:widget: {component, options} api is used", () => {
                ...
                expect(
                    console.warn.calledWithMatch(
                        /ui:widget object is deprecated/
                    )
                ).to.be.true;
            });
        ...
        describe("options", () => {
            ...
            describe("direct reference", () => {
                ...
                it("should render a custom widget with options", () => {
                    ...
                    expect(node.querySelectorAll(".custom")).to.have.length.of(
                        1
                    );
                });
            });
        ...
        describe("enum fields native options", () => {
            ...
            it("should merge enumOptions with custom options", () => {
                const { node } = createFormComponent({ schema, uiSchema });
                expect(
                    node.querySelectorAll(".custom option")
                ).to.have.length.of(2);
            });
        });
        ...
        describe("enum fields disabled options", () => {
            ...
            it("should have atleast one option disabled", () => {
                const { node } = createFormComponent({ schema, uiSchema });
                const disabledOptionsLen =
                    uiSchema.field["ui:enumDisabled"].length;
                expect(
                    node.querySelectorAll("option:disabled")
                ).to.have.length.of(disabledOptionsLen);
                expect(
                    node.querySelectorAll("option:enabled")
                ).to.have.length.of(
    ...
    describe("string", () => {
        ...
        describe("textarea", () => {
            ...
            it("should set a placeholder value", () => {
                ...
                expect(node.querySelector("textarea").placeholder).eql(
                    "sample"
                );
            });
        });
        ...
        describe("password", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(
                    node.querySelectorAll("[type=password]")
                ).to.have.length.of(1);
            });
            ...
            it("should set a placeholder value", () => {
                ...
                expect(node.querySelector("[type=password]").placeholder).eql(
                    "sample"
                );
            });
        });
        ...
        describe("color", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(node.querySelectorAll("[type=color]")).to.have.length.of(
                    1
                );
            });
        ...
        describe("hidden", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(
                    node.querySelectorAll("[type=hidden]")
                ).to.have.length.of(1);
            });
    ...
    describe("string (enum)", () => {
        ...
        describe("radio", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(node.querySelectorAll("[type=radio]")).to.have.length.of(
                    2
                );
            });
            ...
            it("should support formData", () => {
                ...
                expect(node.querySelectorAll("[type=radio]")[1].checked).eql(
                    true
                );
            });
    ...
    describe("number", () => {
        ...
        describe("updown", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(
                    node.querySelectorAll("[type=number]")
                ).to.have.length.of(1);
            });
        ...
        describe("range", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(node.querySelectorAll("[type=range]")).to.have.length.of(
                    1
                );
            });
    ...
    describe("boolean", () => {
        ...
        describe("select", () => {
            ...
            it("should accept a uiSchema object", () => {
                ...
                expect(
                    node.querySelectorAll("select option")
                ).to.have.length.of(3);
            });
            ...
            it("should render boolean option labels", () => {
                ...
                expect(node.querySelectorAll("option")[1].textContent).eql(
                    "yes"
                );
                expect(node.querySelectorAll("option")[2].textContent).eql(
                    "no"
                );
            });
        ...
        describe("Fields", () => {
            describe("ArrayField", () => {
                ...
                it("should disable the Add button", () => {
                    expect(
                        node.querySelector(".array-item-add button").disabled
                    ).eql(true);
                });

                it("should disable the Delete button", () => {
                    expect(
                        node.querySelector(".array-item-remove").disabled
                    ).eql(true);
                });
            });
    ...
    describe("Readonly", () => {
        ...
        describe("Widgets", () => {
            function shouldBeReadonly(selector, schema, uiSchema) {
                const { node } = createFormComponent({ schema, uiSchema });
                expect(
                    node.querySelector(selector).hasAttribute("readonly")
                ).eql(true);
            }
            function shouldBeDisabled(selector, schema, uiSchema) {
                const { node } = createFormComponent({ schema, uiSchema });
